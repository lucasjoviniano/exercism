...
function affirm(message) {
  ...
  switch (message.tag | 0) {
    ...
    case /* MatchInlineSnapshot */17 :
        return expect(message[0]).toMatchInlineSnapshot(message[1]);
    case /* MatchSnapshot */18 :
        return expect(message[0]).toMatchSnapshot();
    case /* MatchSnapshotName */19 :
        return expect(message[0]).toMatchSnapshot(message[1]);
    case /* ThrowsMatchSnapshot */20 :
        return expect(message[0]).toThrowErrorMatchingSnapshot();
    case /* Defined */21 :
        var match$46 = message[0];
...
function toMatchInlineSnapshot(inlineSnapshot, param) {
  return /* MatchInlineSnapshot */Block.__(17, [
            param[1],
            inlineSnapshot
          ]);
}
...
function toMatchSnapshot(param) {
  return /* MatchSnapshot */Block.__(18, [param[1]]);
}

function toMatchSnapshotWithName(name, param) {
  return /* MatchSnapshotName */Block.__(19, [
            param[1],
            name
          ]);
}
...
function toThrowErrorMatchingSnapshot(param) {
  return /* ThrowsMatchSnapshot */Block.__(20, [param[1]]);
}
...
function toBeDefined(a) {
  return /* Defined */Block.__(21, [a]);
}

function toBeFalsy(a) {
  return /* Falsy */Block.__(22, [a]);
}

function toBeNull(a) {
  return /* Null */Block.__(23, [a]);
}
...
function toContainProperties(props, p) {
  return /* ObjectContains */Block.__(26, [mapMod((function (a) {
                    return /* tuple */[
                            a,
                            props
                          ];
...
function toMatchObject(b, p) {
  return /* ObjectMatch */Block.__(27, [mapMod((function (a) {
                    return /* tuple */[
                            a,
                            b
                          ];
